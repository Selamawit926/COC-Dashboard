...
const Graph = () => {
  ...
  return (
    <div className="col-span-12 rounded-xl border md:h-60 xl:h-60 sm:h-150 border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
      <div className='grid grid-cols-1 md:grid-cols-3 md:divide-x md:divide-slate-400/25'>
        ...
        <div className="flex flex-col justify-between items-center h-full">
          ...
          <div className='flex flex-col ml-10 pt-13'>
            <div className='sm:text-5xl md:text-7xl font-bold text-black font-sans'>{cocData?.totalCocThisMonth}</div>
