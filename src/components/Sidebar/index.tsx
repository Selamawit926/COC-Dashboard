                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-xl mt-4 h-12 px-4 py-2 font-bold text-black duration-300 ease-in-out dark:hover:bg-meta-4 ${
                          (pathname === '/' ||
                            pathname.includes('dashboard')) &&
                          'dark:bg-meta-4'
                        }`}
